            ...
            <div className="flex items-center justify-center h-[700px] bg-[#F2F2F2] mt-[50px] mb-[90px] w-[650px] mx-auto">
                <form>
                    <div className='flex items-center justify-center flex-row gap-20'>
                        ...
                        <p className='flex items-center justify-center  mb-[50px] text-xl font-semibold text-gray-900 pl-[80px] '>3/3</p>
                    </div>
                    <div className="mb-4">
                        <label htmlFor="name" className="block text-gray-700 text-sm font-bold mb-2">Position</label>
                        <input type="text" id="name" className="px-4 py-2 border border-gray-300 rounded-md w-full"  />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">Start Date</label>
                        <DatePicker
                            id="dob"
                    ...
                    <div className="mb-4">
                        <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">End Date</label>
                        <DatePicker
                            id="dob"
                            onChange={date => setSelectedDate(date)}
                            className="px-4 py-2 border border-gray-300 rounded-md w-full"
                    ...
                    <div className="mb-4">
                        <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">Languages</label>
                        <input type="email" id="email" className="px-4 py-2 border border-gray-300 rounded-md w-full" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">Profile Picture</label>
                        <input type="email" id="email" className="px-4 py-2 border border-gray-300 rounded-md w-full" />
                    </div>
                    <Link href="/">
